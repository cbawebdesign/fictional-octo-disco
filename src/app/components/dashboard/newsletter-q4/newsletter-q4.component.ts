...
// export interface User extends User { businessName: string };
...
@Component({
  selector: 'app-newsletter-q4',
  templateUrl: './newsletter-q4.component.html',
  styleUrls: ['./newsletter-q4.component.scss']
})
export class NewsletterQ4Component  {
