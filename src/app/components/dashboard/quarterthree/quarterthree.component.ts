...
// import {q32020Item} from 'src/models/q32020-item';
...
//   createItem = '';
// q32020ItemsDoc: AngularFirestoreDocument<Item>;
// q32020Items: Observable<q32020Item[]>;
...
//   await this.q32020ItemsDoc.collection<q32020Item>('q32020Items').doc(id).set(q32020Item)
//     .then(() => {
...
// };
// // async is not necessary here, but using it to control event loop
// async deleteItem(groceryItem: q32020Item) {
//   await this.q32020ItemsDoc.collection<q32020Item>('q32020Items').doc(groceryItem.id).delete()
...
//   this.q32020ItemsDoc = this.afs.doc<Item>('user/' + uid);
//   this.q32020Items = this.q32020ItemsDoc.collection<q32020Item>('q32020Items').valueChanges();
...
// download(uid: string) {
//   return this.q32020ItemsDoc = this.afs.doc<Item>('user/' + uid);
